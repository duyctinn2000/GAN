...
//                }
    ...
    public static Bitmap convertArrayToBitmap(float[][][][] imageArray, int imageWidth, int imageHeight,int[] bitmapValue) {
...
//        }
        ...
        for (int x = 0; x < imageArray[0].length; x++) {
            for (int y = 0;  y < imageArray[0][0].length; y++) {
                ...
                // Create black and transparent bitmap based on pixel value above a certain number eg. 150
                // make all pixels black in case value of grayscale image is above 150
                float r = (float) (255.0f * (imageArray[0][0][x][y] * 0.5f + 0.5f));
                float g = (float) (255.0f * (imageArray[0][1][x][y] * 0.5f + 0.5f));
                float b = (float) (255.0f * (imageArray[0][2][x][y] * 0.5f + 0.5f));
//                if (pixel>70) {
//                    blackWhiteImage.setPixel(y,x,Color.WHITE);
//                } else {
//                    blackWhiteImage.setPixel(y,x,Color.BLACK);
//                }
    ...
    public static Bitmap convertArrayToBitmap(long[][][] imageArray, int imageWidth, int imageHeight) {
...
//            for (int x=0; x < imageArray[0].length; x++) {
//                for (int y=0; y < imageArray[0][0].length; y++) {
//                    if (maxValue<imageArray[m][x][y]) {
//                        maxValue = imageArray[m][x][y];
//                    }
//                    if (minValue>imageArray[m][x][y]) {
//                        minValue = imageArray[m][x][y];
//                    }
//                }
//            }
//        }
...
//        Bitmap blackWhiteImage = Bitmap.createBitmap(imageWidth, imageHeight, Bitmap.Config.ARGB_8888);
        ...
        for (int x = 0; x < imageArray[0].length; x++) {
            for (int y = 0;  y < imageArray[0][0].length; y++) {
                ...
                // Create black and transparent bitmap based on pixel value above a certain number eg. 150
                // make all pixels black in case value of grayscale image is above 150
                float r = (float) (255.0f * ((imageArray[0][x][y] + 1) / 2));
                float g = (float) (255.0f * ((imageArray[1][x][y] + 1) / 2));
                float b = (float) (255.0f * ((imageArray[2][x][y] + 1) / 2));
//                if (pixel>70) {
//                    blackWhiteImage.setPixel(y,x,Color.WHITE);
//                } else {
//                    blackWhiteImage.setPixel(y,x,Color.BLACK);
